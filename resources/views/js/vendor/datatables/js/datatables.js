...
// POSIÇÃO DOS ELEMENTOS PESQUISA, MENSAGEM - "sDom": "<'row'<'col-sm-12 datatables-toolbar'<'pull-right'f><'pull-left'i>r<'clearfix'>>>t<'row'<'col-sm-12 datatables-footer'<'pull-left'l><'pull-right'p><'clearfix'>>>",
