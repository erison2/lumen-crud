...
var Core = function () {
    ...
    var runPrepJS = function () {
        ...
        $(window).load(function () {
            ...
            var scripts = {
                // HIGH PRIORITY
                gmap: 'js/vendor/map/gmaps.min.js',
                jquerymap: 'js/vendor/gmap/jquery.ui.map.js',
                mixitup: 'js/vendor/mixitup/jquery.mixitup.min.js',
                mpopup: 'js/vendor/mfpopup/dist/jquery.magnific-popup.min.js',
                chosen: 'js/vendor/chosen/chosen.jquery.min.js',
                moment: 'js/vendor/daterange/moment.min.js',
                globalize: 'js/vendor/globalize/globalize.js',
                // FORM PICKERS
                cpicker: 'js/vendor/colorpicker/bootstrap-colorpicker.js',
                timepicker: 'js/vendor/timepicker/bootstrap-timepicker.min.js',
                datepicker: 'js/vendor/datepicker/bootstrap-datepicker.js',
                daterange: 'js/vendor/daterange/daterangepicker.js',
                // FORMS
                validate: 'js/vendor/validate/jquery.validate.js',
                masked: 'js/vendor/jquerymask/jquery.maskedinput.min.js',
                // FORMS TOOLS
                holder: 'js/bootstrap/holder.js',
                tagmanager: 'js/vendor/tags/tagmanager.js',
                gritter: 'js/vendor/gritter/js/jquery.gritter.min.js',
                ladda: 'js/vendor/ladda/ladda.min.js',
                switcher: 'js/vendor/formswitch/js/bootstrap-switch.min.js',
                paginator: 'js/bootstrap/paginator/src/bootstrap-paginator.js',
                knob: 'js/vendor/jquerydial/jquery.knob.js',
                rangeslider: 'js/vendor/rangeslider/jQAllRangeSliders.min.js',
                // MED PRIORITY - Large File sizes
                charts: 'js/charts.js',
                ckeditorCDN: 'http://cdnjs.cloudflare.com/ajax/libs/ckeditor/4.0.1/ckeditor.js',
                xedit: 'js/editors/xeditable/js/bootstrap-editable.js',
                summernote: 'js/editors/summernote/summernote.js',
                elfinder: 'js/vendor/elfinder/js/elFinder.js',
                countdown: 'js/vendor/countdown/jquery.countdown.js',
                jcrop: 'js/vendor/imagecrop/js/jquery.Jcrop.min.js',
                imagezoom: 'js/vendor/imagezoom/jquery.elevatezoom.min.js',
                sketchpad: 'js/vendor/notepad/wPaint.min.js',
                scrollto: 'js/vendor/scrollto/jquery.scrollTo-1.4.3.1-min.js',
                fileupload: 'js/bootstrap/fileupload/fileupload.js',
                fitvids: 'js/vendor/fitvids/jquery.fitvids.js',
                // LARGE IMAGES
